...
public class GameRules extends JFrame {
	...
	public GameRules() {
		...
		mani.setFont(new Font("바탕", Font.BOLD, 30));
		background.add(mani);
	...
	textcat.setFont(new Font("바탕", Font.BOLD, 17));
	...
	textdog.setFont(new Font("바탕", Font.BOLD, 17));
	...
	textfish.setSize
	(250,100);
	textfish.setFont(new Font("바탕", Font.BOLD, 17));
