...
public class NyangiGame extends JFrame {
	...
	public NyangiGame() {
		...
		for(int i=0; i<3; i++) {
			for(int j=0; j<3; j++) {
				// 구멍 아이콘 생성
				ImageIcon himg = new ImageIcon("C:\\Users\\user\\Desktop\\images\\hole.png");
		...
		// +1 이미지
		ImageIcon poimg = new ImageIcon("C:\\Users\\user\\Desktop\\images\\plusone.png");
		JLabel plusone = new JLabel(poimg);
		plusone.setSize(poimg.getIconWidth(),poimg.getIconWidth());
		// -3 이미지
		ImageIcon m3img = new ImageIcon("C:\\Users\\user\\Desktop\\images\\minus3.png");
		JLabel minus3 = new JLabel(m3img);
		minus3.setSize(m3img.getIconWidth(),m3img.getIconWidth());
		// +5 이미지
		ImageIcon p5img = new ImageIcon("C:\\Users\\user\\Desktop\\images\\plus5.png");
		...
		// 포커스 아이콘 생성
		ImageIcon fimg = new ImageIcon("C:\\Users\\user\\Desktop\\images\\focus.png");
